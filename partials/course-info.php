<section class="infinite-section group/section">
	...
	<div class="infinite-grid mt-6">
		...
		get_template_part('partials/course-info', 'card', ['title' => 'Rescheduling & Cancellations', 'items' => [
			['item_text' => 'Course enrollments can be transferred to another class if your request is made more than 5 business days prior to original course.'],
			['item_text' => 'Courses can be rescheduled 1 time for no fee if requested 5 business day or more prior to start date.'],
			['item_text' => 'Any cancellation requests received within 5 business days prior to class, will only receive a 50% refund of that course price. Students who "no-show" to any course will not be entitled to any refund for that course.'],
